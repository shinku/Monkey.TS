...
var MF_Canvas = (function (_super) {
    ...
    MF_Canvas.prototype.doDraw = function () {
    ...
    MF_Canvas.prototype.update = function () {
        ...
        var offset = this.roateAnglePosition(this.x / this._scale, this.y, -this.rotation / 180 * Math.PI);
    ...
    Object.defineProperty(MF_Canvas.prototype, "scale", {
        ...
        set: function (val) {
            ...
            this._scale = val;
            this.context.save();
            var w = this.imgPosition.width * (this.offsetscale + 1);
            var h = this.imgPosition.height * (this.offsetscale + 1);
            this.update();
        },
        enumerable: true,
        configurable: true
